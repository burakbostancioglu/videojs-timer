...
(function(window, videojs) {
  ...
  timer = function(options) {
    ...
    function time_updated(time_update_event){
        ...
        var progress_event = new CustomEvent(options.event_name, {"detail":{ "total":duration, "position": time}});
        document.dispatchEvent(progress_event);
        //todo dispach global event
        //console.log(time);
    }
  };
